  ...
  return (
    ...
    >
      ...
      >
        ...
        <path className="bottomArrow" d="m26 5 6 6-6 6M69 48v7c0 7.732-6.268 14-14 14h-7" />
        <path
          className="knot"
        ...
        <path className="triangles" d="m29 45-10 6 10 6 10-6zM38 58l-9 8-9-8M38 44l-9-8-9 8" />
      </g>
    </svg>
    </div>
  )
